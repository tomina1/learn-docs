import{_ as n,c as s,o as a,a3 as p}from"./chunks/framework.CqX4AtrM.js";const k=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"test/jest.md","filePath":"test/jest.md","lastUpdated":1714383083000}'),e={name:"test/jest.md"},l=p(`<p>全局设定</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>beforeAll / beforeEach / afterEach / afterAll (fn, timeout)：所有前后/开始前后钩子、超时时间 = default 5s</span></span>
